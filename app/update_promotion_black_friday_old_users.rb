...
require 'date'
require 'logger'
class UpdatePromotionBlackFridayOldUsers < ActiveRecord::Base

  ### RUN IN DEV:
  ### rvm use 1.8.7;cd /home/sgj700/rails_apps/hf1/;ruby script/runner app/update_promotion_black_friday_old_users.rb

  ### RUN IN PRODUCTION:
  ### cd /habitforge/current;RAILS_ENV=production /usr/bin/ruby /home/jurowsk1/etc/rails_apps/habitforge/current/script/runner /home/jurowsk1/etc/rails_apps/habitforge/current/app/update_promotion_black_friday_old_users.rb
  #RAILS_ENV=production 
  #/usr/bin/ruby 
  #/home/jurowsk1/etc/rails_apps/habitforge/current/script/runner 
  #/home/jurowsk1/etc/rails_apps/habitforge/current/app/update_promotion_black_friday_old_users.rb
...
records_array = ActiveRecord::Base.connection.execute(sql)
      ...
      old_users_sql = ""
      user_conditions = "kill_ads_until is null and promotion_black_friday_2014_sent is null and (unsubscribed_from_promo_emails = 0 or unsubscribed_from_promo_emails is null)"    
    end
