	...
	xml_variant_id = 0
	   ...
	   xml_variant_id = item.elements['line-item/variant-id'].text.to_i
	     ...
	     #### SHOPIFY PRODUCT IDs
             ...
             if (xml_product_id == 49 and xml_variant_id == 27) or xml_product_id == 33131182 or xml_product_id == 63752422 or xml_product_id == 63868112 or xml_product_id == 63752802 or xml_product_id == 63753272
                 ...
                 if account_located == 1
                     ...
                     ### 33131182 = 12-month Supporting Membership
                     if (xml_product_id == 49 and xml_variant_id == 27) or xml_product_id == 33131182
