    ...
    def redirect_to_ssl_login
      ...
      if local_request? == false
        if (request.url.include? 'https://')
          ...
          if (request.url.include? '/user_session/new' or request.url.include? '/account' or request.url.include? '/users/' or request.url.include? '/widget/upgrade')
          ...
          if (request.url.include? '/user_session/new' or request.url.include? '/account' or request.url.include? '/widget/upgrade')          
